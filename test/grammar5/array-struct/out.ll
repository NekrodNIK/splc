...
entry:
  ...
  store [3 x %Point] zeroinitializer, ptr %points, align 4
  ...
  store i64 5, ptr %fieldaddr8, align 4
  ...
  store i64 6, ptr %fieldaddr10, align 4
  ...
  %fieldtmp = load i64, ptr %fieldaddr12, align 4
  ...
  %fieldtmp18 = load i64, ptr %fieldaddr17, align 4
