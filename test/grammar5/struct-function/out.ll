...
entry:
  ...
  %px1 = load i64, ptr %px, align 4
  store i64 %px1, ptr %fieldaddr, align 4
  %fieldaddr2 = getelementptr inbounds nuw %Point, ptr %p, i32 0, i32 1
  %py3 = load i64, ptr %py, align 4
  store i64 %py3, ptr %fieldaddr2, align 4
...
entry:
  ...
  store %Point zeroinitializer, ptr %pt, align 4
  %calltmp = call %Point @makePoint(i64 3, i64 4)
  %copy_tmp = alloca %Point, align 8
  store %Point %calltmp, ptr %copy_tmp, align 4
